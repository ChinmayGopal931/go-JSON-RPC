...
import {PoolModifyLiquidityTest} from "../utils/PoolModifyLiquidityTestPermit.sol";
...
import {PoolSettleTest} from "@uniswap/v4-core/src/test//PoolSettleTest.sol";
...
} from "@uniswap/v4-core/src/test/ProtocolFeeControllerTest.sol";
...
contract Deployers {
    ...
    function swapWithPermit(
        ...
        console.log("swapWithPermit sender", msg.sender);

        return swapRouter.swapWithPermit(
            user,
            _key,
            IPoolManager.SwapParams({
                zeroForOne: zeroForOne,
